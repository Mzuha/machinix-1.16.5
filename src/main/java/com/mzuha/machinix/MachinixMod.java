...
import com.mzuha.machinix.block.screen.MaceratorScreen;
...
@Mod(MOD_ID)
public class MachinixMod {
    public static final String MOD_ID = "machinix";
    ...
    private void doClientStuff(final FMLClientSetupEvent event) {
        ...
        ScreenManager.registerFactory(
            ModContainers.MACERATOR_CONTAINER.get(), MaceratorScreen::new
        );
    }
