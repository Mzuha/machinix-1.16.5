...
import com.mzuha.machinix.block.tileentity.CrusherBlockTileEntity;
...
import static com.mzuha.machinix.block.tileentity.CrusherBlockTileEntity.TICKS_FOR_OPERATION;

public class CrusherContainer extends Container {

    private final CrusherBlockTileEntity tileEntity;
    private final PlayerEntity playerEntity;
    private final IItemHandler playerInventory;


    public CrusherContainer(int windowId, World world, BlockPos blockPos,
                            PlayerInventory playerInventory, PlayerEntity playerEntity) {
        super(ModContainers.CRUSHER_CONTAINER.get(), windowId);
        this.tileEntity = (CrusherBlockTileEntity) world.getTileEntity(blockPos);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()),
            playerIn, ModBlocks.CRUSHER.get());
    }
    ...
    public int getScaledProgress() {
        ...
        int maxProgress = TICKS_FOR_OPERATION;  // Max Progress
    ...
    public boolean isCrafting() {
        return tileEntity.getProgress() > 0;
    }
